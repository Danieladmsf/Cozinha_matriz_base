    ...
    const resolveUserTenant = useCallback(async (firebaseUser) => {
        try {
            ...
            if (userSnap.exists()) {
                ...
                // Aguardamos a conclusão para garantir que o usuário só vê a UI
                // quando os dados de fábrica já estão disponíveis.
                try {
                    console.log('[TenantProvider] 🏭 Iniciando seed de dados de fábrica...');
                    ...
                    if (seedRes.ok && seedResult.success) {
                        ...
                        console.error('[TenantProvider] 🏭 Falha no seed:', seedRes.status, seedResult);
                    }
