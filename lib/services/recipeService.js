...
export async function loadRecipe(recipeId) {
    ...
    try {
        const recipeRef = getDocRef('Recipe', recipeId);
        ...
        if (!recipeSnap.exists()) {
            ...
            try {
                const productRef = getDocRef('Product', recipeId);
                ...
                if (productSnap.exists()) {
                    ...
                    if (prodName) {
                        ...
                        if (!querySnapshot.empty) {
                            ...
                            const allRecipesQuery = query(getCollectionRef('Recipe'), where('type', '==', 'produtos'));
