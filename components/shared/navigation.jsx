        ...
        <div className="p-4 border-t text-center">
          {(!sidebarCollapsed || isHovering) && (
            <div className="flex flex-col items-center justify-center text-xs text-gray-500 space-y-1">
              <span>Daniel Mello © 2026</span>
              <div className="flex items-center">
                <svg className="w-3 h-3 text-green-500 mr-1" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
